...
export const recallEvalFixtures: RecallFixture[] = [
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User is visiting Tokyo in October.",
        source: "explicit",
        key: "trip_tokyo",
        daysOld: 5,
      },
      ...
      {
        content: "User wants hotel recommendations near Shinjuku.",
        source: "extracted",
        daysOld: 4,
      },
      {
        content: "User uses TypeScript for most projects.",
        source: "explicit",
        key: "lang",
        daysOld: 50,
      },
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User is training for their first marathon.",
        source: "explicit",
        key: "fitness_goal",
        daysOld: 14,
      },
      ...
      {
        content: "User usually runs on Tuesday and Saturday mornings.",
        source: "extracted",
        daysOld: 9,
      },
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User is studying for the CPA exam.",
        source: "explicit",
        key: "exam",
        daysOld: 6,
      },
      ...
      {
        content: "User struggles with bond accounting questions.",
        source: "extracted",
        daysOld: 3,
      },
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User has a son named Liam who loves astronomy.",
        source: "explicit",
        key: "child",
        daysOld: 12,
      },
      ...
      {
        content: "User wants weekend science activities for Liam.",
        source: "extracted",
        daysOld: 4,
      },
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User's team uses Linear for project tracking.",
        source: "explicit",
        key: "pm_tool",
        daysOld: 25,
      },
      ...
      {
        content: "User is training for a marathon.",
        source: "explicit",
        key: "fitness_goal",
        daysOld: 9,
      },
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User struggles with partnership accounting questions.",
        source: "extracted",
        daysOld: 90,
      },
      {
...

  {
    ...
    corpus: [
      ...
      {
        content: "User wants metric units in recipes.",
        source: "explicit",
        key: "recipe_units",
        daysOld: 25,
      },
  ...
  },
  {
    ...
    corpus: [
      ...
      {
        content: "User deploys on Cloudflare Workers.",
        source: "explicit",
        key: "runtime",
        daysOld: 14,
      },
  ...
  },
  {
    ...
    corpus: [
      {
        content: "User's son Liam loves astronomy.",
        source: "explicit",
        key: "child_interest",
        daysOld: 16,
      },
  ...
  },
  {
    ...
    corpus: [
      ...
      {
        content: "User wants practice questions with explanations.",
        source: "extracted",
        daysOld: 7,
      },
  ...
  },
  {
    id: "recall-030",
    description:
      "Explicit food constraint without embedding should survive against semantically-rich extracted distractors",
    tags: ["null_embedding"],
    corpus: [
